<?php 
    ...
    $server="localhost";
    $port="3308"; /*localización del servidor, ahi puede ir también la ip del dispositivo que aloja la bd */
    $db="plf";   /* bd a la cual se quiere acceder*/
    $con= mysqli_connect($server,$user,$pass, $port) or die("Error al conectar");      /* variable para hacer la conección contiene el servidor, el usuario y su contraseña*/
